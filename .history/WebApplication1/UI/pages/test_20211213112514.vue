<template>
  ...
  >
    ...
    >
      ...
      <!-- LARGE <section v-if="image.Size === 'large'" class="image text-center text-bottom">
...
<span class="image-copy">Foto: blablabla</span>
      ...
      <!-- <section MIDDLE class="image text-right text-top">
...
<p class="image-caption">{{ image.Filename }}</p>
      ...
      <section class="image text-left text-top">
        <div class="image-aside">
